document.addEventListener('DOMContentLoaded', () => {
  ...
  // LOGICA TURNOS (MOSTRAR SE HOUVER HORÁRIO)
  ...
  // --- TABELA MEDICAÇÕES (ORDENADA POR HORÁRIO) ---
